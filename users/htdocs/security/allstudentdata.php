          ...
          <td bgcolor="#E6E600">Mobile</td>
           <td bgcolor="#E6E600">Course</td>
            <td bgcolor="#E6E600">Photo</td>
             ...
             <td bgcolor="#E6E600">10+2</td>
                <td bgcolor="#E6E600">Graduation</td>
  </tr>
...
?>
  ...
  <form method="post" action="d8.php">
     <input type="submit" name="export" class="btn btn-success" value="Export/Download- without image" />
    </form>
