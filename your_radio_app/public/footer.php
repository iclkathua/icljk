            ...
            <div class="modal fade" id="modal-admob-app-id" tabindex="-1" role="dialog">
                <div class="modal-dialog modal-lg" role="document">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h4 class="modal-title" id="largeModalLabel">Update your AndroidManifest.xml</h4>
                        </div>
                        <div class="modal-body">
                            <p>Add your <b>AdMob App ID</b> to your app's AndroidManifest.xml file by adding a <b><meta-data></b> tag with name <b>com.google.android.gms.ads.APPLICATION_ID</b>, as shown below.</p>
                            <p>You can find your <b>App ID</b> in the AdMob UI. For <b>android:value</b> insert your own AdMob App ID in quotes, as shown below.</p>
                            <img src="assets/images/admob_app_id.jpg" class="img-responsive">
                            <i>Important: This step is required as of latest Google Mobile Ads SDK version 19.4.0. Failure to add this <meta-data> tag results in a crash with the message: The Google Mobile Ads SDK was initialized incorrectly.</i>
                        </div>
                        <div class="modal-footer">
                            <button type="button" class="btn btn-link waves-effect" data-dismiss="modal">OK, I AM UNDERSTAND</button>
                        </div>
