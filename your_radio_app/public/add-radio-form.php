 <?php include ('functions.php'); ?>
   ...
   <section class="content">
        ...
        <ol class="breadcrumb">
            ...
            <li class="active">Add Radio</a></li>
        </ol>
                        ...
                        <div class="body">
                            ...
                            <div>
                                    ...
                                    <div class="form-group col-sm-12">
                                        ...
                                        <div class="form-line">
                                            <input type="text" class="form-control" name="radio_url" id="radio_url" placeholder="ex : http://live.radiorodja.com/ or http://202.147.199.100:8000/" required>
                                        </div>
                                    </div>
