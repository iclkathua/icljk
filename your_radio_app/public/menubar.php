...
<!--     <div class="search-bar">
    ...
    <nav class="navbar">
        <div class="container-fluid">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="dashboard.php">YOUR RADIO APP</a>
            </div>
    ...
    <section>
        ...
        <aside id="leftsidebar" class="sidebar">
            ...
            <div class="legal">
                <div class="copyright">
                    Copyright &copy; 2021 <a href="https://www.solodroid.id" target="_blank">Solodroid Developer</a>
                </div>
                <div class="version">
                    <b>Version: </b> 5.2.0
                </div>
